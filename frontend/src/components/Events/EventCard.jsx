...
const EventCard = ({ active }) => {
  return (
    <div
      className={`w-[95%] block lg:flex bg-white rounded-lg  p-2 ${
    ...
    >
      ...
      <div className="w-full lg:[w-50%] flex flex-col justify-center pr-5">
        ...
        <div className="flex py-2 justify-between">
          ...
          <span className="pt-3 pr-6 font-[600] text-[22px] text-[#44a55e] ">120 sold</span>
        </div>
        <CountDown />
        <br />
