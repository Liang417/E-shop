const styles = {
  ...
  productDiscountPrice:
    'font-bold text-[0.85rem] md:text-[1rem] xl:text-[1.1rem] text-[#333] font-Roboto',
  price:
    'font-[500] text-[0.85rem] md:text-[1rem] xl:text-[1.1rem] text-[#d55b45] mt-[-4px] line-through',
  shop_name: 'pt-3 text-[16px] text-blue-400 pb-3',
  ...
  cart_button:
    'px-[15px] 400px:px-[20px] h-[38px] rounded-[20px] bg-[#f63b60] flex items-center justify-center cursor-pointer',
  cart_button_text: 'text-[#fff] text-[14px] 800px:text-[16px] font-[600] ',
